...
<div id="wrapper">
    ...
    <!-- Sidebar -->
    <jsp:include page="principal/sidebar.jsp"></jsp:include>
    <!-- End of Sidebar -->
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="text-center">
                    ...
                    <p class="lead text-gray-800 mb-5">Opa, algo não saiu como o esperado</p>
                    <p class="text-danger-500 mb-0">Algo de errado na matrix: <% System.out.print(request.getParameter("msg")); %></p>
                    <a href="<%= request.getContextPath()%>/principal/principal.jsp">&larr; Voltar para o painel</a>
                </div>
            <!-- /.container-fluid -->
...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Clique em "Sair" se tiver certeza de que quer encerrar a sessão.</div>
